package com.projeto.notificacao.business;

import com.projeto.notificacao.business.dto.TarefaDTO;
import com.projeto.notificacao.infrastructure.exceptions.EmailException;
...
public class EmailService {
    ...
    public void enviaEmail(TarefaDTO dto){
        if (dto.getEmailUsuario() == null || dto.getEmailUsuario().isBlank()) {
            throw new EmailException("O endereço de email do usuário não pode ser nulo ou vazio");
        }
        try{
